...
const generatePassResetEmail = (data: {
  client: string
  email: string
  url: string
  t: TFunction
...
<head>
  ...
  <title>${t('email.passwordReset.title')}</title>
          ...
          <tr>
            ...
            >
              ...
              <p
                ...
                "
              >
                ${t('email.passwordReset.security')}
              </p>
...
export default generatePassResetEmail
