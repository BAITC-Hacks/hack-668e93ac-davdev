...
export function findMaterialsByName(root: THREE.Object3D, names: string[]): THREE.Material[] {
  ...
  root.traverse((object) => {
    ...
    for (const material of materials) {
      if (names.includes(material.name)) found.add(material);
    }
  });
...
export function findMeshByMaterial(root: THREE.Object3D, materialName: string): THREE.Mesh | null {
  ...
  root.traverse((object) => {
    ...
    if (materials.some((material) => material?.name === materialName)) found = mesh;
  });

  return found;
}

export function findMeshesByMaterial(root: THREE.Object3D, materialName: string): THREE.Mesh[] {
  ...
  root.traverse((object) => {
    ...
    if (materials.some((material) => material?.name === materialName)) found.push(mesh);
  });
...
export function findRigBone(root: THREE.Object3D, boneName: string): THREE.Bone | null {
