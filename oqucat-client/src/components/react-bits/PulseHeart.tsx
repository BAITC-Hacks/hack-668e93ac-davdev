...
import { MdFavorite, MdStar, MdThumbUp } from 'react-icons/md'
...
const OUT = 0.4
const ICONS: Record<PulseHeartIcon, ReactNode> = {
  heart: <MdFavorite />,
  star: <MdStar />,
  thumb: <MdThumbUp />,
}
...
const PulseHeart: React.FC<PulseHeartProps> = ({
  ...
  const iconNode =
    typeof icon === 'string'
      ? ICONS[icon as PulseHeartIcon] || ICONS.heart
      : null
